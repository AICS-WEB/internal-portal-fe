...
export default function AttendancePage({ data, currentUser, actions }) {
  ...
  const selectedRows = useMemo(
    () => data.attendanceRecords.filter((record) => record.date === selectedDate),
    [data.attendanceRecords, selectedDate],
  );
  ...
  return (
    <div className="page-stack">
      ...
      <section className="panel">
        <label className="field attendance-date-filter">
          <span>조회 날짜</span>
      ...
      <DataTable columns={columns} rows={selectedRows} />
    </div>
  );
}
