      ...
      render: (request) => {
        ...
        return (
          <div className="table-actions">
            ...
            {canReview && ["approved", "rejected"].includes(request.status) ? (
              <Button size="sm" variant="secondary" onClick={() => actions.updateItem("leaveRequests", request.id, { status: "pending" })}>재검토</Button>
            ) : null}
            {canDelete ? (
